...
bird_downflap = pygame.transform.scale2x(pygame.image.load(
    os.path.join(assets_dir, 'bluebird-downflap.png')).convert_alpha())
bird_midflap = pygame.transform.scale2x(pygame.image.load(
    os.path.join(assets_dir, 'bluebird-midflap.png')).convert_alpha())
bird_upflap = pygame.transform.scale2x(pygame.image.load(
    os.path.join(assets_dir, 'bluebird-upflap.png')).convert_alpha())
...
pipe_surface = pygame.image.load(
    os.path.join(assets_dir, 'pipe-green.png')).convert()
